...
from multiprocessing import Queue,SimpleQueue, Array, Value
...
class Performance:
    ...
    # 线程 | 进程 细粒度的配置
    course_process_mode = 'process' # [thread, process, other] thread: 多线程 |  process: 多进程 | other : 单线程
    th_course_multiple_nums = 2 # 处理一个课程, 处理章节分配的线程|进程 数量 | 总线程(进程)数 = 课程线程 * 章节线程 * 视频线程
    chapter_process_mode = 'thread' # [thread, process, other] thread: 多线程 |  process: 多进程 | other : 单线程
    th_chapter_multiple_nums = 3 # 处理一个章节的每个视频的线程|进程 数量 | 总线程(进程)数 = 章节线程 * 视频线程
