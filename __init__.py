...
from .core.video import Assember, Video,Chapter,Course
...
class VSearcher:
    ...
    def executeVideo(self, video_file_path) -> Video:
        return Assember.executeVideo( video_path=video_file_path )

    def executeChapter(self, chapter_dir_path) -> Chapter:
        return Assember.executeChapter( chapter_dir_path=chapter_dir_path )

    def executeCourse(self, course_dir_path) -> Course:
